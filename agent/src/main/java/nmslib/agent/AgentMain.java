...
public final class AgentMain {
    ...
    public static void premain(final String agentArgs, final Instrumentation instrumentation) {
        ...
        patches.getProxyRegistry()
                ...
                .addProxy(nmsNBTBase, apiNmsNBTBase)
                .addProxy(nmsNBTTagCompound, apiNmsNBTTagCompound)
                .addProxy(nmsNBTBaseNBTNumber, apiNmsNBTBaseNBTNumber)
                .addProxy(nmsNBTTagEnd, apiNmsNBTTagEnd)
                .addProxy(nmsNBTTagByte, apiNmsNBTTagByte)
                .addProxy(nmsNBTTagShort, apiNmsNBTTagShort)
                .addProxy(nmsNBTTagInt, apiNmsNBTTagInt)
                .addProxy(nmsNBTTagLong, apiNmsNBTTagLong)
                .addProxy(nmsNBTTagFloat, apiNmsNBTTagFloat)
                .addProxy(nmsNBTTagDouble, apiNmsNBTTagDouble)
                .addProxy(nmsNBTTagIntArray, apiNmsNBTTagIntArray)
                .addProxy(nmsNBTTagByteArray, apiNmsNBTTagByteArray)
                .addProxy(nmsNBTTagString, apiNmsNBTTagString)
                .addProxy(nmsNBTTagList, apiNmsNBTTagList)
